...
public class FormEntity extends BaseTimeEntity {
    ...
    public static FormEntity create(MemberEntity member, String title, String category, Map<String, Object> content, String etc, String phone) {
    ...
    public void update(String title, Map<String, Object> content, String etc, String phone) {
        setTitle(title);
        setContent(content);
        setEtc(etc);
        setPhone(phone);
