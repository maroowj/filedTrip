...
public class ReservationQueryRepositoryImpl extends QuerydslRepositorySupport implements ReservationQueryRepository {
    ...
    @Override
    public Page<UserReservationListResponse> userReservationList(Pageable pageable, MemberEntity member) {
        JPAQuery<UserReservationListResponse> query = queryFactory
                .select(Projections.constructor(UserReservationListResponse.class,
                        reservationEntity.reservationSeq,
                        reservationEntity.applicant,
                ...
                .leftJoin(reservationEntity.firstCourse, firstCourseEntity)
                .where(
                        reservationEntity.member.eq(member)
                )
                .offset(pageable.getOffset())
                .limit(pageable.getPageSize());
        ...
        QueryResults<UserReservationListResponse> result = query.fetchResults();
